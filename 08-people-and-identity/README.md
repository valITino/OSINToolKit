...
| [Google Lens](reverse-image/google-lens.md) | What is actually **in** this photo - the building, the sign, the product - and where else does this scene appear? | 2 | passive |
...
| [hunter.io](email-osint/hunter-io.md) | I have a company domain and a person's name. What address format does this organisation use, and is the address I derived... | 2 | passive |
