...
| [mnemonic PassiveDNS](passive-dns/mnemonic-pdns.md) | I have a domain, or the IP it resolves to today. What did that name resolve to before, and what other names have answered from... | 2 | passive |
...
| [Validin](passive-dns/validin.md) | I have a domain or an IP. What did it resolve to over the last few years, what else has lived on that address or netblock, and... | 2 | passive |
